export const designSystems = {
  brochure: {
    systemKey: "brochure",
    label: "Brochure",
    assetsBase: "/design-system/systems/brochure/assets",
    tokens: {
      backgroundColor: () => import("../systems/brochure/tokens/proofs/backgroundColor.tokens.mjs"),
      buttonFrame: () => import("../systems/brochure/tokens/proofs/buttonFrame.tokens.mjs"),
      contentWidth: () => import("../systems/brochure/tokens/proofs/contentWidth.tokens.mjs"),
      focusRing: () => import("../systems/brochure/tokens/proofs/focusRing.tokens.mjs"),
      supportingTextStyle: () => import("../systems/brochure/tokens/proofs/supportingTextStyle.tokens.mjs"),
      labelTextStyle: () => import("../systems/brochure/tokens/proofs/labelTextStyle.tokens.mjs"),
      linkDecoration: () => import("../systems/brochure/tokens/proofs/linkDecoration.tokens.mjs"),
      linkTextStyle: () => import("../systems/brochure/tokens/proofs/linkTextStyle.tokens.mjs"),
      listMarkerStyle: () => import("../systems/brochure/tokens/proofs/listMarkerStyle.tokens.mjs"),
      minimumTargetSize: () => import("../systems/brochure/tokens/proofs/minimumTargetSize.tokens.mjs"),
      panelCornerRadius: () => import("../systems/brochure/tokens/proofs/panelCornerRadius.tokens.mjs"),
      pipelineShowcaseFrame: () => import("../systems/brochure/tokens/proofs/pipelineShowcaseFrame.tokens.mjs"),
      primaryColorSource: () => import("../systems/brochure/tokens/proofs/primaryColorSource.tokens.mjs"),
      primaryTintedBackground: () => import("../systems/brochure/tokens/proofs/primaryTintedBackground.tokens.mjs"),
      primaryTintedForeground: () => import("../systems/brochure/tokens/proofs/primaryTintedForeground.tokens.mjs"),
      spacingScale: () => import("../systems/brochure/tokens/proofs/spacingScale.tokens.mjs"),
      surfaceFrame: () => import("../systems/brochure/tokens/proofs/surfaceFrame.tokens.mjs"),
      tooltipSurface: () => import("../systems/brochure/tokens/proofs/tooltipSurface.tokens.mjs"),
      tooltipTextStyle: () => import("../systems/brochure/tokens/proofs/tooltipTextStyle.tokens.mjs"),
      typographyScale: () => import("../systems/brochure/tokens/proofs/typographyScale.tokens.mjs"),
      visualProofOrnament: () => import("../systems/brochure/tokens/proofs/visualProofOrnament.tokens.mjs"),
    },
  },
  default: {
    systemKey: "default",
