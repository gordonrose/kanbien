...
const designSystemBreadcrumbChains = new Map([
  ...
  ["/design-system/templates/record_management_list_centric", [
    { href: "/design-system/templates", label: "Home" },
    { href: "/design-system/templates/record_management_list_centric", label: "record_management_list_centric" },
  ]],
...
const topNavCanonicalReferenceStates = [
  ...
  { ref: "TRP-010", label: "Magnified desktop", fixture: "long-labels", width: 880, open: "closed", theme: "normal", direction: "ltr", magnification: 100, accent: "#635bff", circumstance: "Magnified desktop shell with long labels, preserving readable centered navigation without control crowding." },
