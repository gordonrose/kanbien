...
downloadButton?.addEventListener("click", () => {
  ...
  window.setTimeout(() => {
    ...
    repeatButton.innerHTML = '<svg viewBox="0 0 24 24" focusable="false" aria-hidden="true"><path d="M12 4a8 8 0 0 1 7.45 5.1l-2.3.9A5.5 5.5 0 1 0 17 14h-3.5v-2.5H21V19h-2.5v-3.05A8 8 0 1 1 12 4zm1.25 4v4.15l3 1.8L15 16.1l-4.25-2.55V8z" /></svg>';
