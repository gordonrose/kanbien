...
export const tokenDefinitionV1 = {
  ...
  tokenDefinitionPath:
    "docs/design-system/02-token/systems/brochure/primary-tinted-background/PrimaryTintedBackground-Implementation.md",
  page: {
    route: "/design-system/brochure/tokens/primary-tinted-background",
    htmlPath: "src/frontend/designSystem/systems/brochure/tokens/primary-tinted-background/index.html",
  ...
  codeSeam: {
    ...
    governedRuntimeModule: "src/frontend/designSystem/layers/02-token/primary-tinted-background/systems/brochure.mjs",
    systemProofModule: "src/frontend/designSystem/systems/brochure/tokens/proofs/primaryTintedBackground.tokens.mjs",
