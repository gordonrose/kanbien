...
export const tokenDefinitionV1 = {
  ...
  tokenDefinitionPath: "docs/design-system/02-token/systems/brochure/focus-ring/FocusRing-Implementation.md",
  page: {
    route: "/design-system/brochure/tokens/focus-ring",
    htmlPath: "src/frontend/designSystem/systems/brochure/tokens/focus-ring/index.html",
  ...
  codeSeam: {
    ...
    governedRuntimeModule: "src/frontend/designSystem/layers/02-token/focus-ring/systems/brochure.mjs",
    systemProofModule: "src/frontend/designSystem/systems/brochure/tokens/proofs/focusRing.tokens.mjs",
