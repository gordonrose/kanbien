...
export const tokenDefinitionV1 = {
  ...
  tokenDefinitionPath: "docs/design-system/02-token/systems/brochure/label-text-style/LabelTextStyle-Implementation.md",
  page: {
    route: "/design-system/brochure/tokens/label-text-style",
    htmlPath: "src/frontend/designSystem/systems/brochure/tokens/label-text-style/index.html",
  ...
  codeSeam: {
    ...
    governedRuntimeModule: "src/frontend/designSystem/layers/02-token/label-text-style/systems/brochure.mjs",
    systemProofModule: "src/frontend/designSystem/systems/brochure/tokens/proofs/labelTextStyle.tokens.mjs",
  ...
  variants: [
    {
      ...
      derivation: {
        ...
        renderedValue: "0.9rem / 1.2 at weight 800",
      },
      preview: {
...
export const labelTextStyleTokenSpec = {
  ...
  summaryPanels: [
    {
      label: "Short label",
      title: "Brochure compact label typography",
      variantId: "label-text-style-short-default",
      supportingText: "A stronger compact label weight carries the brochure editorial control style.",
    },
  ],
  variantFields: [
    ["role", "Role"],
