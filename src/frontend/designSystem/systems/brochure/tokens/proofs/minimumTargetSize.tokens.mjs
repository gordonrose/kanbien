...
export const tokenDefinitionV1 = {
  ...
  tokenDefinitionPath: "docs/design-system/02-token/systems/brochure/minimum-target-size/MinimumTargetSize-Implementation.md",
  page: {
    route: "/design-system/brochure/tokens/minimum-target-size",
    htmlPath: "src/frontend/designSystem/systems/brochure/tokens/minimum-target-size/index.html",
  ...
  codeSeam: {
    ...
    governedRuntimeModule: "src/frontend/designSystem/layers/02-token/minimum-target-size/systems/brochure.mjs",
    systemProofModule: "src/frontend/designSystem/systems/brochure/tokens/proofs/minimumTargetSize.tokens.mjs",
