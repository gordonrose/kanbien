...
export const tokenDefinitionV1 = {
  ...
  tokenDefinitionPath:
    "docs/design-system/02-token/systems/brochure/primary-tinted-foreground/PrimaryTintedForeground-Implementation.md",
  page: {
    route: "/design-system/brochure/tokens/primary-tinted-foreground",
    htmlPath: "src/frontend/designSystem/systems/brochure/tokens/primary-tinted-foreground/index.html",
  ...
  codeSeam: {
    ...
    governedRuntimeModule: "src/frontend/designSystem/layers/02-token/primary-tinted-foreground/systems/brochure.mjs",
    systemProofModule: "src/frontend/designSystem/systems/brochure/tokens/proofs/primaryTintedForeground.tokens.mjs",
