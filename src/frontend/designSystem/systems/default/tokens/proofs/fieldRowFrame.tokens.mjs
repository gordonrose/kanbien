  ...
  variants: [
    {
      ...
      preview: {
        ...
        rowGap: bodyRegionFrame.gapValue,
        labelToControlGap: "0.5rem",
        controlToMessageGap: "0.375rem",
        controlSlotMinBlockSize: minimumTarget.minimumHeight,
        label: "Field label",
        control: "Hosted control slot",
        message: "Helper or error message",
      },
      metadata: {
        frameRole: "field row frame",
