  ...
  summaryPanels: [
    {
      ...
      supportingText: "Root source for original-theme derived primary colors.",
    },
    {
      label: "Dark",
      title: "Dark primary source",
      variantId: "primary-color-source-dark",
      supportingText: "Root source for dark-theme derived primary colors.",
    },
    {
      label: "Desert",
      title: "Desert primary source",
      variantId: "primary-color-source-desert",
      supportingText: "Root source for desert-theme derived primary colors.",
    },
  ],
  diagnostic: {
