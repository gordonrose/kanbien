...
export const tokenDefinitionV1 = {
  ...
  tokenDefinitionPath: "docs/design-system/02-token/systems/default/button-frame/ButtonFrame-Implementation.md",
  page: {
    route: "/design-system/default/tokens/button-frame",
    htmlPath: "src/frontend/designSystem/systems/default/tokens/button-frame/index.html",
  ...
  codeSeam: {
    ...
    governedRuntimeModule: "src/frontend/designSystem/layers/02-token/button-frame/systems/default.mjs",
    systemProofModule: "src/frontend/designSystem/systems/default/tokens/proofs/buttonFrame.tokens.mjs",
