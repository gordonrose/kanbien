...
} from "../../../../layers/03-primitive/icon-button-control/index.mjs";
...
const firstSpec = iconButtonControlPrimitive({
  id: "icon-button-proof",
  label: "Add item",
  value: "add-item",
  frameIntent: "subtle",
});
  ...
  <section class="token-spec-page">
    <div class="token-spec-layout">
      <section class="token-spec-intro">
        ...
        <h1>Icon Button Control Primitive</h1>
        <p>Review the governed native-button primitive for icon-only actions.</p>
      </section>
      ...
      <section class="token-spec-section" aria-label="Primitive proof">
        ...
        <div class="primitive-proof-stage">
          <article class="primitive-proof-row">
            <p class="primitive-proof-label">Subtle add action</p>
          ...
          <article class="primitive-proof-row">
            <p class="primitive-proof-label">Quiet add action</p>
            <div class="primitive-proof-host">
              ${renderIconButtonControlPrimitive({
                id: "icon-button-proof-quiet",
                label: "Add quiet item",
                value: "add-quiet-item",
                frameIntent: "quiet",
              })}
            </div>
          </article>
...
const log = root.querySelector("[data-icon-button-control-log]");
