...
VALUES
  ('tenant-auth-policy.read', 'Read the effective tenant auth policy for a tenant.', TRUE, TRUE, NOW(), NOW()),
  ('tenant-auth-policy.update', 'Update tenant-scoped tenant auth policy overrides.', TRUE, TRUE, NOW(), NOW())
