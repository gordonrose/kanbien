...
Layer ask guidance for layers `03` through `10` still lives in
`01-behavior-rule/SKILL.md` until those layers become active. Layer `02-token`
has its own active skill and evals.
