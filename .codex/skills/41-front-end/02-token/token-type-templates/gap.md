...
Use this template when tokenDefinitionV1.tokenType is gap.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "gap-sample"
  },
  "variantSchema": {
    "valueFields": [
      "gapRole",
  ...
  "exampleOutput": {
    "pageKey": "gap",
    "pageRoute": "/design-system/default/tokens/gap",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/gap/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/gap.tokens.mjs",
    "systemTokenExport": "gapTokenSpec"
  }
}
```
