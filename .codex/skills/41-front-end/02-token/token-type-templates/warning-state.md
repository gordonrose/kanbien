# warning-state Token Template

Use this template when tokenDefinitionV1.tokenType is warning-state.
...
```json
{
  ...
  "exampleOutput": {
    "pageKey": "warning-state",
    "pageRoute": "/design-system/default/tokens/warning-state",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/warning-state/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/warningState.tokens.mjs",
    "systemTokenExport": "warningStateTokenSpec"
  }
}
```
