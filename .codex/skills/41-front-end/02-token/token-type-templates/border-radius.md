# border-radius Token Template

Use this template when tokenDefinitionV1.tokenType is border-radius.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "radius-box"
  },
  "variantSchema": {
    "valueFields": [
      "radiusRole",
  ...
  "exampleOutput": {
    "pageKey": "border-radius",
    "pageRoute": "/design-system/default/tokens/border-radius",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/border-radius/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/borderRadius.tokens.mjs",
    "systemTokenExport": "borderRadiusTokenSpec"
  }
}
```
