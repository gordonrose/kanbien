...
Use this template when tokenDefinitionV1.tokenType is surface.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "surface-card"
  },
  "variantSchema": {
    "valueFields": [
      "surfaceRole",
  ...
  "exampleOutput": {
    "pageKey": "surface",
    "pageRoute": "/design-system/default/tokens/surface",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/surface/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/surface.tokens.mjs",
    "systemTokenExport": "surfaceTokenSpec"
  }
}
```
