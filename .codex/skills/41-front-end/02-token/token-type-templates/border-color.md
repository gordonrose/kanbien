# border-color Token Template

Use this template when tokenDefinitionV1.tokenType is border-color.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "border-sample"
  },
  "variantSchema": {
    "valueFields": [
      "borderRole",
  ...
  "exampleOutput": {
    "pageKey": "border-color",
    "pageRoute": "/design-system/default/tokens/border-color",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/border-color/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/borderColor.tokens.mjs",
    "systemTokenExport": "borderColorTokenSpec"
  }
}
```
