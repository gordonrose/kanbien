# line-height Token Template

Use this template when tokenDefinitionV1.tokenType is line-height.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "line-height-sample"
  },
  "variantSchema": {
    "valueFields": [
      "lineHeightRole",
    ...
    "previewKind": "line-height-sample",
    "metadataFields": [
      "lineHeightRole",
      "pairedFontSize",
      "textRole",
  ...
  "exampleOutput": {
    "pageKey": "line-height",
    "pageRoute": "/design-system/default/tokens/line-height",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/line-height/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/lineHeight.tokens.mjs",
    "systemTokenExport": "lineHeightTokenSpec"
  }
}
```
