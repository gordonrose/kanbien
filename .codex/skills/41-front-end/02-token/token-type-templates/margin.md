# margin Token Template

Use this template when tokenDefinitionV1.tokenType is margin.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "margin-box"
  },
  "variantSchema": {
    "valueFields": [
      "marginRole",
  ...
  "exampleOutput": {
    "pageKey": "margin",
    "pageRoute": "/design-system/default/tokens/margin",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/margin/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/margin.tokens.mjs",
    "systemTokenExport": "marginTokenSpec"
  }
}
```
