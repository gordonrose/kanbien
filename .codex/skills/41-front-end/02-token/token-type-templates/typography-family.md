# typography-family Token Template

Use this template when tokenDefinitionV1.tokenType is typography-family.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "font-sample"
  },
  "variantSchema": {
    "valueFields": [
      "fontRole",
  ...
  "exampleOutput": {
    "pageKey": "typography-family",
    "pageRoute": "/design-system/default/tokens/typography-family",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/typography-family/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/typographyFamily.tokens.mjs",
    "systemTokenExport": "typographyFamilyTokenSpec"
  }
}
```
