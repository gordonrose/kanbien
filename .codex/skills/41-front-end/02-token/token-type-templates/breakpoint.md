# breakpoint Token Template

Use this template when tokenDefinitionV1.tokenType is breakpoint.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "breakpoint-range"
  },
  "variantSchema": {
    "valueFields": [
      "breakpointRole",
  ...
  "exampleOutput": {
    "pageKey": "breakpoint",
    "pageRoute": "/design-system/default/tokens/breakpoint",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/breakpoint/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/breakpoint.tokens.mjs",
    "systemTokenExport": "breakpointTokenSpec"
  }
}
```
