# background-color Token Template

Use this template when tokenDefinitionV1.tokenType is background-color.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "surface-swatch"
  },
  "variantSchema": {
    "valueFields": [
      "backgroundRole",
  ...
  "exampleOutput": {
    "pageKey": "background-color",
    "pageRoute": "/design-system/default/tokens/background-color",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/background-color/index.html",
