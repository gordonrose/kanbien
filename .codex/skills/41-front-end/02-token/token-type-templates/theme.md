...
Use this template when tokenDefinitionV1.tokenType is theme.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "theme-comparison"
  },
  "variantSchema": {
    "valueFields": [
      "themeRole",
  ...
  "exampleOutput": {
    "pageKey": "theme",
    "pageRoute": "/design-system/default/tokens/theme",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/theme/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/theme.tokens.mjs",
    "systemTokenExport": "themeTokenSpec"
  }
}
```
