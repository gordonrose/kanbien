# color-palette Token Template

Use this template when tokenDefinitionV1.tokenType is color-palette.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "color-swatch"
  },
  "variantSchema": {
    "valueFields": [
      "paletteRole",
  ...
  "exampleOutput": {
    "pageKey": "color-palette",
    "pageRoute": "/design-system/default/tokens/color-palette",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/color-palette/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/colorPalette.tokens.mjs",
    "systemTokenExport": "colorPaletteTokenSpec"
  }
}
```
