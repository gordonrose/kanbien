# success-state Token Template

Use this template when tokenDefinitionV1.tokenType is success-state.
...
```json
{
  ...
  "variantSchema": {
    ...
    "useCaseInstructionFields": [
      "allowedUse",
      "forbiddenUse",
      "colorIndependentRule"
    ]
  },
  "exampleOutput": {
    "pageKey": "success-state",
    "pageRoute": "/design-system/default/tokens/success-state",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/success-state/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/successState.tokens.mjs",
    "systemTokenExport": "successStateTokenSpec"
  }
}
```
