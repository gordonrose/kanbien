# border-width Token Template

Use this template when tokenDefinitionV1.tokenType is border-width.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "border-width-sample"
  },
  "variantSchema": {
    "valueFields": [
      "borderRole",
    ...
    "previewKind": "border-width-sample",
    "metadataFields": [
      "borderRole",
      "affectedSides",
      "theme",
  ...
  "exampleOutput": {
    "pageKey": "border-width",
    "pageRoute": "/design-system/default/tokens/border-width",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/border-width/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/borderWidth.tokens.mjs",
    "systemTokenExport": "borderWidthTokenSpec"
  }
}
```
