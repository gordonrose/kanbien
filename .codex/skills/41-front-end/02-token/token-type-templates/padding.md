# padding Token Template

Use this template when tokenDefinitionV1.tokenType is padding.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "padding-box"
  },
  "variantSchema": {
    "valueFields": [
      "paddingRole",
  ...
  "exampleOutput": {
    "pageKey": "padding",
    "pageRoute": "/design-system/default/tokens/padding",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/padding/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/padding.tokens.mjs",
    "systemTokenExport": "paddingTokenSpec"
  }
}
```
