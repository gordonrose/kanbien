# density Token Template

Use this template when tokenDefinitionV1.tokenType is density.
...
```json
{
  ...
  "pageStructure": {
    ...
    "previewRendererKind": "density-comparison"
  },
  "variantSchema": {
    "valueFields": [
      "densityRole",
      "densityValue",
      "affectedTokenMappings",
      "targetSizeImpact",
      "contentFitRule",
      "allowedConsumers"
    ],
    "previewKind": "density-comparison",
    "metadataFields": [
      "densityRole",
      "affectedTokenMappings",
      "targetSizeImpact",
