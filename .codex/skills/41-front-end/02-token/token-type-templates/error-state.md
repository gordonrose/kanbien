# error-state Token Template

Use this template when tokenDefinitionV1.tokenType is error-state.
...
```json
{
  ...
  "exampleOutput": {
    "pageKey": "error-state",
    "pageRoute": "/design-system/default/tokens/error-state",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/error-state/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/errorState.tokens.mjs",
    "systemTokenExport": "errorStateTokenSpec"
  }
}
```
