# disabled-state Token Template

Use this template when tokenDefinitionV1.tokenType is disabled-state.
...
```json
{
  ...
  "variantSchema": {
    ...
    "useCaseInstructionFields": [
      "allowedUse",
      "forbiddenUse",
      "disabledAffordanceRule"
    ]
  },
  "exampleOutput": {
    "pageKey": "disabled-state",
    "pageRoute": "/design-system/default/tokens/disabled-state",
    "pageHtmlPath": "src/frontend/designSystem/systems/default/tokens/disabled-state/index.html",
    "systemTokenModule": "src/frontend/designSystem/systems/default/tokens/definitions/disabledState.tokens.mjs",
    "systemTokenExport": "disabledStateTokenSpec"
  }
}
```
