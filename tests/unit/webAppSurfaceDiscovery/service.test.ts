...
describe("webAppSurfaceDiscovery service", () => {
  it("TC-WEB-APP-SURF-DISC-UNIT-001 and TC-ROOT-PATH-UNIT-004 persist support-only and canonical path-backed root-admin discovery truth during a manual run", async () => {
