...
export async function resetPostgresTestDatabase(pool: Pool): Promise<void> {
  await pool.query(`
    ...
    DROP TABLE IF EXISTS job_processing_recurring_schedule_run CASCADE;
    DROP TABLE IF EXISTS job_processing_recurring_schedule CASCADE;
    ...
    DROP TABLE IF EXISTS organization_business_unit_membership_audit_event CASCADE;
    DROP TABLE IF EXISTS organization_business_unit_membership CASCADE;
    DROP TABLE IF EXISTS organization_business_unit_audit_event CASCADE;
    DROP TABLE IF EXISTS organization_business_unit CASCADE;
    DROP TABLE IF EXISTS organization_location_audit_event CASCADE;
    DROP TABLE IF EXISTS organization_location CASCADE;
    DROP TABLE IF EXISTS organization_legal_profile_audit_event CASCADE;
    DROP TABLE IF EXISTS organization_legal_profile CASCADE;
    DROP TABLE IF EXISTS organization_audit_event CASCADE;
