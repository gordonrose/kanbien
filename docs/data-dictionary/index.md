...
| Organization Legal Profile | `organizationLegalDetails` | Planned durable official legal-details record for one Organization, including one-active-profile posture and retained history/export rules. | [organization-legal-profile.md](./organization-legal-profile.md) |
| Organization Location | `organizationLocations` | Planned durable place-of-operation record for one Organization, including descriptive head-office flags and Organization-domain lifecycle. | [organization-location.md](./organization-location.md) |
| Organization Weekly Opening Hours | `locationOpeningHours` | Planned optional recurring weekly availability slots for an Organization Location. | [organization-weekly-opening-hours.md](./organization-weekly-opening-hours.md) |
| Organization Business Unit | `businessUnits` | Planned durable internal Organization structure record with parent/child hierarchy, max-depth, branch archive, and export posture. | [organization-business-unit.md](./organization-business-unit.md) |
| Organization Business Unit Membership | `businessUnitMemberships` | Planned durable link from a real user or role to an Organization Business Unit, with privacy/security-adjacent seam requirements. | [organization-business-unit-membership.md](./organization-business-unit-membership.md) |
| Organization Integration Record | `organizationIntegrations` | Planned durable high-level Organization integration relationship that explicitly excludes credentials, endpoints, webhook secrets, payload examples, and provider configuration. | [organization-integration-record.md](./organization-integration-record.md) |
