...
| --- | --- | --- | --- | --- |
| Durable domain data rule | yes | enforced-by-maintained-artifact | This data dictionary page; `AGENTS.md` durable domain data rule | Design System Canonical Family is documented as owned by `designSystemCanonicals` with source record(s) `design_system_canonical_families`, `DesignSystemCanonicalFamilyRecord`. |
