...
- `docs/workspace-buckets/archive-history/product-request-examples/2026-05-06-product-request-example-chat-interface.md`
...
- it contains stale status and artifact-link posture for work that later gained
  real Product Request folders, epics, stories, task breakdown, Layer 5 runs,
