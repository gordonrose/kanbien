# Story Breakdown Story: PRD-derived test case planning
...
- Delivery Shape:
  `TEST:test-only`
- Job To Be Done:
  As QA governance, I need TC obligations for loop evidence behavior before delivery tasks.
- Actor / System Perspective:
  QA governance
- Outcome:
  Test-case packet covers persistence, API, helper, scorecard, and traceability behavior.
- Non-goals:
