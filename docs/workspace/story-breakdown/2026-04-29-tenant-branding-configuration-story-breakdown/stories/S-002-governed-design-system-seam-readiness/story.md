...
| --- | --- | --- | --- | --- | --- |
| AC-S002-01 | design-system maintainer; frontend architect; governed seams absent or partial; root-admin form states; dashboard branding states | Root-admin branding form design-system readiness | human-visible-parity | TC obligation: cover design-system canonical review; accessibility review for Design-system governance identifies signed-off seams or records a blocker for root-admin form composition, upload status, colour preview, accessibility metadata control, validation states, and fallback messaging. | yes |
| AC-S002-02 | design-system maintainer; frontend architect; governed seams absent or partial; root-admin form states; dashboard branding states | Tenant dashboard branding design-system readiness | human-visible-parity | TC obligation: cover visual scenario review; accessibility review for Design-system governance identifies signed-off seams or records a blocker for tenant dashboard branding consumption across missing, partial, invalid, not-ready, cross-tenant-denied, mobile, magnified, RTL, light, and dark states. | yes |
