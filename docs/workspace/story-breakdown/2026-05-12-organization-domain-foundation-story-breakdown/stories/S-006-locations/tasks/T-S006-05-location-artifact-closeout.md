# T-S006-05: Refresh S-006 feature-doc and story evidence after implementation lands.
...
| Execution Scope | Refresh S-006 feature-doc and story evidence after implementation lands. |
| Allowed Write Set | `docs/features/organization-location.md`; S-006 story folder; S-006 review artifact; generated dependency graph artifacts when manifest changes require regeneration. |
| Non-Goals | No production source changes, no new product decisions, no other entity docs beyond dependency notes. |
| Dependencies | T-S006-01 through T-S006-04 complete. |
