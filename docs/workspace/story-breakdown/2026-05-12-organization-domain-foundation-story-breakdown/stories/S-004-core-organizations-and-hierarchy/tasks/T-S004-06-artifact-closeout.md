# T-S004-06: Refresh S-004 feature-doc and story evidence after implementation lands.
...
| Execution Scope | Refresh S-004 feature-doc and story evidence after implementation lands. |
| Allowed Write Set | `docs/features/organization-core.md`; `docs/workspace/story-breakdown/2026-05-12-organization-domain-foundation-story-breakdown/stories/S-004-core-organizations-and-hierarchy/**`; `docs/workspace/reviews/*organization*S004*.md`; generated dependency graph artifacts if manifest changes require regeneration. |
| Non-Goals | No production source changes, no new product decisions, no child entity docs beyond dependency notes. |
| Dependencies | T-S004-01 through T-S004-05 complete. |
