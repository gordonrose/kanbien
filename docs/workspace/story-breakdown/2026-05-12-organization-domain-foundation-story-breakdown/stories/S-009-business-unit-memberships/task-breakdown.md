...
- Validation command:
  `npm run task-breakdown:validate -- docs/workspace/story-breakdown/2026-05-12-organization-domain-foundation-story-breakdown/stories/S-009-business-unit-memberships --story docs/workspace/story-breakdown/2026-05-12-organization-domain-foundation-story-breakdown`
- Validation status:
  `pass`
...
- Story blockers carried forward:
  none for S-009 source implementation; app UI, grouped search, private export job assembly, individual/person target implementation remains outside this task breakdown until an approved lookup seam exists.
...
| --- | --- | --- | --- | --- | --- |
| TS-ORG-001 | architecture-foundation-required | DECISION:architecture-foundation | deferred: S-003 complete | deferred-with-owner | Domain family metadata is already governed before S-009 source work. |
| TS-ORG-002 | feature-local | DEV:migration-persistence | deferred: S-004 complete | deferred-with-owner | Organization core records are a prerequisite consumed by S-009. |
| TS-ORG-003 | feature-local | DEV:migration-persistence | deferred: S-005 complete | deferred-with-owner | Legal profiles are a completed prerequisite sibling, not part of S-009. |
| TS-ORG-004 | feature-local | DEV:migration-persistence | deferred: S-006 and S-007 complete | deferred-with-owner | Locations and opening hours are completed prerequisites, not part of S-009. |
| TS-ORG-005 | feature-local | DEV:migration-persistence | T-S009-01 | covered | Business-unit memberships belong in `organizationBusinessUnitMemberships`; business-unit hierarchy is the prerequisite from S-008. |
...
| TS-ORG-007 | feature-public-seam | DOC:asset-decision | deferred: S-012 | deferred-with-owner | Logo work is outside S-009. |
| TS-ORG-008 | feature-local | DECISION:architecture-foundation | deferred: S-010 | deferred-with-owner | Reference catalogues are outside S-009. |
...
| TS-ORG-010 | platform-seam | DECISION:job-cleanup | blocked: S-014 and S-015 | deferred-with-owner | Export job assembly is outside S-009; S-009 only exposes membership projections for later export consumption. |
| TS-ORG-011 | feature-public-seam | DOC:permission-mapping | T-S009-03, T-S009-04 | covered | Runtime tasks consume the completed Organization permission mapping. |
| TS-ORG-012 | architecture-foundation-required | DECISION:architecture-foundation | deferred: S-013 | deferred-with-owner | Grouped search is outside S-009. |
| TS-ORG-013 | design-system-seam | GOV:design-system | blocked: S-016 | deferred-with-owner | No app UI in S-009. |
| TS-ORG-014 | feature-public-seam | DOC:feature-manifest | T-S009-03, T-S009-05 | covered | Manifest and public projection seam are created with backend integration. |
| TS-ORG-015 | feature-local | DOC:docs-artifact | T-S009-05 | covered | S-009 carries feature docs, story evidence, manifest, and generated graph closeout. |

## Expected Task-Type Reconciliation

| Story ID | Expected Task Type | Source Signal | Covered By Task ID | Missing / Deferred Reason |
| --- | --- | --- | --- | --- |
| S-009 | DEV:backend | membership records | T-S009-02, T-S009-03 | DEV:backend work is split by persistence, domain behavior, transport/authz, proof, and artifact closeout. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T-S009-01 | S-009 | DEV:migration-persistence | Create membership table, lifecycle fields, target fields, role checks, lookup indexes, audit table, and grant seeds. | `src/features/organizationBusinessUnitMemberships/persistence/**`; `tests/integration/organizationBusinessUnits/**`; shared Postgres harness only if required by migration proof. | No individual/person target implementation, no UI, no search implementation, no export job assembly. | S-008 business-unit lookup seam exists; live schema inspection before editing. | organizationBusinessUnits lookup seam; tenant table; migration runner; Postgres harness. | queued-for-delivery |
| T-S009-02 | S-009 | DEV:backend | Implement membership create, read/list, update, archive, restore, delete, fixed-role validation, business-unit target validation, self-link denial, and individual/person target deferral. | `src/features/organizationBusinessUnitMemberships/contract/**`; `src/features/organizationBusinessUnitMemberships/domain/**`; `src/features/organizationBusinessUnitMemberships/persistence/**`; `tests/integration/organizationBusinessUnits/**`. | No transport mounting, no UI, no grouped search, no export bundle generation. | T-S009-01 complete. | organizationBusinessUnitMemberships repository seam; organizationBusinessUnits public lookup seam. | queued-for-delivery |
| T-S009-03 | S-009 | DEV:backend | Add root and tenant membership child routes, authz enforcement, audit events, feature wiring, manifest, and membership route seam. | `src/features/organizationBusinessUnitMemberships/contract/**`; `src/features/organizationBusinessUnitMemberships/transport/**`; `src/features/organizationBusinessUnitMemberships/integration.ts`; `src/features/organizationBusinessUnitMemberships/index.ts`; `src/features/organizationBusinessUnitMemberships/feature.manifest.json`; `src/routes/v1/index.ts`; `tests/integration/organizationBusinessUnits/**`. | No app UI, no OpenAPI/Postman expansion unless already maintained, no export job assembly, no search routes. | T-S009-01 and T-S009-02 complete. | root session middleware, tenant session context, platform authorization, audit seam, v1 router, organizationBusinessUnits object seam. | queued-for-delivery |
| T-S009-04 | S-009 | TEST:test-only | Add S-009 proof suite for business-unit target validation, fixed labels, self-link denial, individual/person target deferral, same-tenant enforcement, lifecycle visibility, and audit rows. | `tests/integration/organizationBusinessUnits/**`; `tests/fixtures/organizationBusinessUnitMemberships/**` if needed. | No production behavior change, no API contract edits, no permission truth edits. | T-S009-01 through T-S009-03 complete. | live API and persistence fixtures must match implementation contracts. | queued-for-delivery |
| T-S009-05 | S-009 | DOC:docs-artifact | Refresh S-009 feature docs and story evidence after implementation lands. | `docs/features/organization-business-unit-memberships.md`; S-009 story folder; generated dependency graph artifacts when manifest changes require regeneration. | No production source changes, no new product decisions, no unrelated entity docs, no API contract rewrite, no permission mapping rewrite. | T-S009-01 through T-S009-04 complete. | feature manifest and generated dependency graph artifact chain. | queued-for-delivery |
...
| --- | --- | --- |
| T-S009-01 | Do not rename existing applied migrations or assume live schema from docs only. | Stop and inspect live schema and migration harness. |
| T-S009-02 | Do not create a membership for an Organization that the actor cannot prove in the same tenant/account. | Stop and refine organizationCore seam or route to architecture review. |
| T-S009-03 | Do not expose routes before runtime authz and object rules exist. | Stop and reconcile permission mapping. |
| T-S009-04 | Do not encode rejected fallback behavior in mocks. | Stop and compare fixtures to live runtime shapes. |
| T-S009-05 | Do not use completion language if generated graph, manifest, docs, or evidence remain stale. | Stop and classify as partially documented. |

## Task-Type Approval Guardrails

| Task ID | Task Type | Required Guardrail Reference | Approval Status | Evidence / Rationale |
| --- | --- | --- | --- | --- |
| T-S009-01 | DEV:migration-persistence | migration-persistence-task-guardrail.md | approved | Migration task is isolated and carries live schema, identity, SQL, and read/write proof obligations. |
| T-S009-02 | DEV:backend | backend-task-guardrail.md | approved | Backend domain behavior is feature-local and consumes migration output. |
| T-S009-03 | DEV:backend | backend-task-guardrail.md | approved | Backend route/auth/audit/manifest work consumes approved API and permission sources. |
| T-S009-04 | TEST:test-only | test-only-task-guardrail.md | approved | Test task changes no production behavior and carries TC traceability plus permission/state matrix. |
| T-S009-05 | DOC:docs-artifact | docs-artifact-task-guardrail.md | approved | Docs closeout is isolated from source implementation and routes specialized changes away. |

## Task Guardrail Evidence

| Task ID | Guardrail Check ID | Status | Evidence |
| --- | --- | --- | --- |
| T-S009-01 | migration-source-authority | pass | Source authority is S-009, PRD, data dictionary, API contracts, and AGENTS migration safety. |
| T-S009-01 | migration-change-class | pass | Change class is new-migration. |
| T-S009-01 | migration-live-schema | pass | Task requires live schema inspection before editing. |
| T-S009-01 | migration-storage-decision-boundary | pass | Storage model is membership table and indexes only. |
| T-S009-01 | migration-source-data-shape | pass | Task lists required memberships fields and indexes. |
| T-S009-01 | migration-per-row-eligibility | pass | Rows must satisfy real same-tenant Organization and real business-unit target and fixed role rules. |
| T-S009-01 | migration-rejected-row-behavior | pass | Invalid rows fail tests and are not silently converted. |
| T-S009-01 | migration-compatibility-repair | pass | Corrective migration is not in scope; drift routes to follow-up. |
| T-S009-01 | migration-applied-file-safety | pass | New zero-padded migration required; applied migrations are not renamed. |
| T-S009-01 | migration-index-normalization-uniqueness | pass | Target, role, tenant, and Organization indexes named. |
| T-S009-01 | migration-security-tenant-proof | pass | Same-tenant and cross-tenant Organization proof required. |
| T-S009-01 | migration-read-write-proof | pass | Representative read/write proof required. |
| T-S009-01 | migration-postgres-harness | pass | Harness review is required. |
| T-S009-02 | backend-source-authority | pass | Uses S-009, PRD, API, data dictionary, permission mapping, blueprint. |
| T-S009-02 | backend-change-class | pass | Change class is domain-behavior. |
| T-S009-02 | backend-owning-feature | pass | Owner is `src/features/organizationBusinessUnitMemberships`. |
| T-S009-02 | backend-source-inventory | pass | Requires organizationCore seam, examples, and membership data dictionary. |
| T-S009-02 | backend-exact-write-envelope | pass | Narrow organizationBusinessUnitMemberships and focused test paths only. |
| T-S009-02 | backend-layer-responsibilities | pass | Contract/domain/repository responsibilities are named. |
| T-S009-02 | backend-cross-feature-seams | pass | Consumes organizationCore public seam; no private persistence imports. |
| T-S009-02 | backend-authz-tenant-lifecycle | pass | Tenant, lifecycle, and business-unit membership posture named. |
| T-S009-02 | backend-api-contract-boundary | pass | API posture consumes approved contracts and routes changes away. |
| T-S009-02 | backend-persistence-migration-boundary | pass | Migration split to T-S009-01. |
| T-S009-02 | backend-scripted-scaffold-posture | pass | No generator assumed; existing patterns must be inspected. |
| T-S009-02 | backend-artifact-obligations | pass | Closeout artifacts split to T-S009-05. |
| T-S009-02 | backend-expected-output | pass | Expected membership behavior and projection named. |
| T-S009-02 | backend-split-routing | pass | Migration and route work are split. |
| T-S009-02 | backend-proof-commands | pass | Focused organizationBusinessUnitMemberships proof commands named. |
| T-S009-02 | backend-human-review-boundary | pass | Review boundary is validation, business-unit membership, tenant/lifecycle behavior. |
| T-S009-03 | backend-source-authority | pass | Uses API contracts, permission mapping, ADR-0036, ADR-0042, S-009. |
| T-S009-03 | backend-change-class | pass | Change class is transport-route. |
| T-S009-03 | backend-owning-feature | pass | Owner is `src/features/organizationBusinessUnitMemberships`. |
| T-S009-03 | backend-source-inventory | pass | Requires route, middleware, audit, manifest examples. |
| T-S009-03 | backend-exact-write-envelope | pass | Narrow organizationBusinessUnitMemberships, v1 router, integration/security test paths only. |
| T-S009-03 | backend-layer-responsibilities | pass | Transport/integration/manifest responsibilities named. |
| T-S009-03 | backend-cross-feature-seams | pass | Root session, tenant context, authz, audit, router, and organizationCore seams named. |
| T-S009-03 | backend-authz-tenant-lifecycle | pass | Runtime authz, tenant context, object rules, denial and audit named. |
| T-S009-03 | backend-api-contract-boundary | pass | Approved root/tenant API contracts consumed. |
| T-S009-03 | backend-persistence-migration-boundary | pass | No schema work; consumes earlier tasks. |
| T-S009-03 | backend-scripted-scaffold-posture | pass | No generator assumed; existing patterns must be inspected. |
| T-S009-03 | backend-artifact-obligations | pass | Manifest/generated graph closeout split to T-S009-05. |
| T-S009-03 | backend-expected-output | pass | Route responses, authz, audit, manifest, public seam named. |
| T-S009-03 | backend-split-routing | pass | Contract or permission drift routes to specialized tasks. |
| T-S009-03 | backend-proof-commands | pass | Focused route, authz, audit, manifest proof named. |
| T-S009-03 | backend-human-review-boundary | pass | Review boundary is route/auth/audit/public seam. |
| T-S009-04 | test-source-authority | pass | Uses PRD test cases and AC-S009-01. |
| T-S009-04 | test-change-class | pass | Change class is prd-test-case. |
| T-S009-04 | test-traceability | pass | TC IDs and AC-S009-01 named. |
| T-S009-04 | test-proof-layer | pass | Unit, integration, security, audit, persistence, concurrency layers named. |
| T-S009-04 | test-permission-state-matrix | pass | Matrix covers actors, permissions, object lifecycle, tenant boundaries. |
| T-S009-04 | test-mock-honesty | pass | Mock-honesty against live API/repository/persistence required. |
| T-S009-04 | test-no-behavior-change | pass | Production behavior changes are forbidden. |
| T-S009-04 | test-sensitive-state-coverage | pass | Active, archived, deleted, and cross-tenant states named. |
| T-S009-04 | test-focused-command | pass | Focused organizationBusinessUnitMemberships test commands named. |
| T-S009-04 | test-coverage-strength | pass | Debt Health Summary includes coverage-strength command. |
| T-S009-04 | test-split-boundary | pass | Missing behavior routes back to DEV tasks. |
| T-S009-05 | docs-source-truth-reviewed | pass | Source truth inventory includes implementation diff, story, PRD, API, data dictionary, permission mapping. |
| T-S009-05 | docs-artifact-class | pass | Class is feature-doc-refresh. |
| T-S009-05 | docs-scriptable-source-inventory | pass | Scriptable inventory and validation commands named. |
| T-S009-05 | docs-stale-artifact-sweep | pass | S-009 docs and generated graph sweep named. |
| T-S009-05 | docs-status-posture | pass | Current-state-after-implementation posture named. |
| T-S009-05 | docs-validation-command | pass | Story and task validation commands named. |
| T-S009-05 | docs-specialized-routing | pass | API, permission, data, source, and test changes are routed away. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| T-S009-01 | feature-local | none | `src/features/organizationBusinessUnitMemberships` | no | not-applicable | New feature-local migration and persistence proof; no shared extraction. | approved |
| T-S009-02 | feature-local | none | `src/features/organizationBusinessUnitMemberships` | no | not-applicable | Feature-local behavior; no shared extraction. | approved |
| T-S009-03 | feature-local | v1 router owns mounting only | `src/features/organizationBusinessUnitMemberships` with explicit v1 mount | no | not-applicable | Existing router/middleware seams consumed without moving shared code. | approved |
| T-S009-04 | feature-local | tests | tests | no | not-applicable | Test-only paths stay in test ownership. | approved |
| T-S009-05 | feature-local | docs | docs | no | not-applicable | Docs/generated artifacts stay in artifact owners. | approved |

## Allowed Write Set Classification

| Task ID | Path Pattern | Write Class | Reason |
| --- | --- | --- | --- |
| T-S009-01 | `src/features/organizationBusinessUnitMemberships/persistence/**` | feature-local | Membership persistence owner. |
| T-S009-01 | `tests/integration/organizationBusinessUnits/**` | test | Persistence proof. |
| T-S009-02 | `src/features/organizationBusinessUnitMemberships/contract/**`; `src/features/organizationBusinessUnitMemberships/domain/**`; `src/features/organizationBusinessUnitMemberships/persistence/**` | feature-local | Membership behavior. |
| T-S009-02 | `tests/integration/organizationBusinessUnits/**` | test | Focused behavior proof. |
| T-S009-03 | `src/features/organizationBusinessUnitMemberships/transport/**`; `src/features/organizationBusinessUnitMemberships/integration.ts`; `src/features/organizationBusinessUnitMemberships/index.ts`; `src/features/organizationBusinessUnitMemberships/feature.manifest.json`; `src/routes/v1/index.ts` | feature-local | Route, integration, manifest, and public seam. |
| T-S009-03 | `tests/integration/organizationBusinessUnits/**` | test | Route and authz proof. |
| T-S009-04 | `tests/integration/organizationBusinessUnits/**`; `tests/fixtures/organizationBusinessUnitMemberships/**` | test | S-009 proof suite. |
| T-S009-05 | `docs/features/organization-business-unit-memberships.md`; S-009 story folder; S-009 review artifacts | docs-artifact | Maintained artifact closeout. |
| T-S009-05 | `docs/architecture/generated/feature-dependency-graph.*` | generated-artifact | Regenerate only when feature manifest changes require it. |

## Forbidden Work

| Task ID | Forbidden Work | Reason |
| --- | --- | --- |
| T-S009-01 | API routes, app UI, grouped search, export job assembly, other Organization child entities. | Persistence task must stay narrow. |
| T-S009-02 | Route mounting, UI, grouped search, export bundle generation. | Domain behavior is isolated. |
| T-S009-03 | App UI, logo/export/search/other child entity routes, broad API contract rewrites. | Route/auth slice must stay S-009 only. |
| T-S009-04 | Production behavior, permission truth, API contract edits. | TEST:test-only cannot change behavior. |
| T-S009-05 | Production source changes or new product decisions. | Docs closeout must follow delivered truth. |

## Task Acceptance Criteria Coverage

| Task ID | AC IDs Covered | Coverage Notes |
| --- | --- | --- |
| T-S009-01 | AC-S009-01 | Covers persistence foundation for memberships fields, indexes, business-unit membership uniqueness, and Organization FK. |
| T-S009-02 | AC-S009-01 | Covers create/read/list/update/archive/restore/delete, fixed role validation, business-unit target validation, self-link denial, lifecycle, and explicit individual/person deferral. |
| T-S009-03 | AC-S009-01 | Covers root/tenant routes, authorization enforcement, object denial, audit, manifest, and public seam. |
| T-S009-04 | AC-S009-01 | Covers executable proof obligations. |
| T-S009-05 | AC-S009-01 | Covers artifact obligations. |

## Task Capability Coverage

| Task ID | Capability Matrix Row(s) Covered | Capability Coverage Status | Notes |
| --- | --- | --- | --- |
| T-S009-01 | `manageOrganizationBusinessUnitMemberships`; `CAP-ORG-MEMBER-001` | approved | Persistence and migration part of membership row. |
| T-S009-02 | `manageOrganizationBusinessUnitMemberships`; `CAP-ORG-MEMBER-001` | approved | Domain behavior part of membership row. |
| T-S009-03 | `manageOrganizationBusinessUnitMemberships`; `CAP-ORG-MEMBER-001` | approved | Runtime route/auth/public seam part of membership row. |
| T-S009-04 | `manageOrganizationBusinessUnitMemberships`; `CAP-ORG-MEMBER-001` | approved | Executable proof for membership row. |
| T-S009-05 | `manageOrganizationBusinessUnitMemberships`; `CAP-ORG-MEMBER-001` | approved | Artifact closeout for membership row. |

## Task Dependencies

| Task ID | Depends On Task ID(s) | Dependency Reason | Must Complete Before Queueing |
| --- | --- | --- | --- |
| T-S009-01 | not-applicable: S-004 prerequisite complete | Memberships require durable Organization and business-unit ownership. | no |
| T-S009-02 | T-S009-01 | Domain behavior needs schema and repository persistence shape. | yes |
| T-S009-03 | T-S009-01; T-S009-02 | Routes should expose implemented behavior with authz and audit. | yes |
| T-S009-04 | T-S009-01; T-S009-02; T-S009-03 | Proof suite targets delivered source behavior. | yes |
| T-S009-05 | T-S009-01; T-S009-02; T-S009-03; T-S009-04 | Artifact closeout needs implementation and proof evidence. | yes |

## Shared Seams

| Task ID | Shared Seam | Seam Type | Existing Or New | Required Contract / Ownership Proof |
| --- | --- | --- | --- | --- |
| T-S009-01 | organizationCore identity and Postgres migration runner | feature/platform seam | existing | Membership table references real Organization records without becoming Organization authority. |
| T-S009-02 | organizationBusinessUnitMemberships repository seam | feature-local seam | new | Domain consumes repository shapes and organizationCore public identity/object seam. |
| T-S009-03 | root session, tenant context, authz, audit, v1 router | platform seams | existing | Transport consumes existing middleware and exposes organizationBusinessUnitMemberships through integration. |
| T-S009-04 | test harness and live runtime/persistence fixtures | test seam | existing | Fixtures must match live API/persistence shape. |
| T-S009-05 | feature manifest and generated dependency graph | generated artifact seam | existing | Manifest changes require graph regeneration and review. |

## Artifact Obligations

| Task ID | Required Artifact | Required Action | Owner Skill Or Workflow | Blocks Delivery Handoff |
| --- | --- | --- | --- | --- |
| T-S009-01 | migration/persistence evidence | record live schema and read/write proof in task evidence | Layer 5 delivery | yes |
| T-S009-02 | source evidence | record domain behavior proof in task evidence | Layer 5 delivery | yes |
| T-S009-03 | feature manifest and dependency graph | update manifest and regenerate graph when public seam/dependency changes | Layer 5 delivery plus artifact sweep | yes |
| T-S009-04 | executable test evidence | record TC and command evidence | test implementation workflow | yes |
| T-S009-05 | feature docs and story evidence | refresh maintained docs and story evidence links | docs artifact workflow | yes |

## Proof And Command Plan

| Task ID | Required Proof Layers | Required Test Or Proof Commands | Mock Honesty / Runtime Evidence Notes |
| --- | --- | --- | --- |
| T-S009-01 | persistence-backed, integration | `npm test -- organizationBusinessUnitMemberships`; migration command used by repo if available. | Use real Postgres harness; no mock-only persistence proof. |
| T-S009-02 | unit, integration, persistence | `npx vitest run tests/integration/organizationBusinessUnits/persistence.test.ts` | Fixtures must match data dictionary and API contract. |
| T-S009-03 | integration, security, audit, compatibility | `npx vitest run tests/integration/organizationBusinessUnits/persistence.test.ts` | Use live route payloads and permission mapping states. |
| T-S009-04 | unit, integration, security, audit, persistence, concurrency | `npx vitest run tests/integration/organizationBusinessUnits/persistence.test.ts`; `npx vitest run tests/integration/organizationBusinessUnits/persistence.test.ts` | Mock-honesty comparison required against real persistence rows and route payloads; route-level security expansion can follow if missing. |
| T-S009-05 | docs-alignment, generated-artifact | `npm run story-breakdown:validate -- docs/workspace/story-breakdown/2026-05-12-organization-domain-foundation-story-breakdown`; `npm run task-breakdown:validate -- docs/workspace/story-breakdown/2026-05-12-organization-domain-foundation-story-breakdown/stories/S-009-business-unit-memberships --story docs/workspace/story-breakdown/2026-05-12-organization-domain-foundation-story-breakdown` | Evidence links must point to actual outputs or explicit placeholders. |
...
| --- | --- | --- | --- | --- | --- |
| T-S009-04 | `npm run test:coverage-strength` | not-run: no such command was executed in this S-009 planning pass | unknown | accepted-deferred | S-009 closeout |
...
| --- | --- | --- | --- | --- | --- | --- |
| T-S009-01 | `task/S007-01-membership-persistence` | isolated task branch/worktree | this task packet | current feature-loop branch | start clean from current reviewed branch | main feature branch after review |
| T-S009-02 | `task/S007-02-membership-behavior` | isolated task branch/worktree | this task packet | after T-S009-01 | include T-S009-01 output only | main feature branch after review |
| T-S009-03 | `task/S007-03-membership-routes-authz` | isolated task branch/worktree | this task packet | after T-S009-02 | include prior S-009 source tasks only | main feature branch after review |
| T-S009-04 | `task/S007-04-membership-proof-suite` | isolated task branch/worktree | this task packet | after T-S009-03 | include completed implementation tasks | main feature branch after review |
| T-S009-05 | `task/S007-05-membership-artifact-closeout` | isolated task branch/worktree | this task packet | after T-S009-04 | include implementation and proof evidence | main feature branch after review |
...
| --- | --- | --- | --- |
| T-S009-01 | queued-for-delivery | none | Start with migration and persistence proof only. |
| T-S009-02 | queued-for-delivery | none | Start after persistence task exists. |
| T-S009-03 | queued-for-delivery | none | Start after domain behavior exists. |
| T-S009-04 | queued-for-delivery | none | Start after source behavior exists; no production source edits. |
| T-S009-05 | queued-for-delivery | none | Start after source and proof evidence exists. |
