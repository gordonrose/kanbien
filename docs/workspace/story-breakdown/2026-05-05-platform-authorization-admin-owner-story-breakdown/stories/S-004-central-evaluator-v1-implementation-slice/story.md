...
| --- | --- | --- | --- | --- | --- |
| AC-S004-01 | protected route; evaluator; selected tenant; selection required; wrong world; lifecycle states; feature unavailable; role missing | evaluator.tenant-context.cross-tenant-deny | runtime-api | TC obligation: cover security; integration for The evaluator v1 slice enforces exactly one tenant context before tenant-scoped authorization and denies cross-tenant access by default. | yes |
| AC-S004-02 | protected route; evaluator; selected tenant; selection required; wrong world; lifecycle states; feature unavailable; role missing | evaluator.decision-proof | runtime-api | TC obligation: cover unit; integration; audit for The evaluator v1 slice produces allow/deny decisions with denial category, public code/status mapping, internal reason, proof, and audit recommendation. | yes |
| AC-S004-03 | protected route; evaluator; selected tenant; selection required; wrong world; lifecycle states; feature unavailable; role missing | evaluator.abac-rebac.typed-extension | source-level | TC obligation: cover unit; architecture review for ABAC/ReBAC/object inputs are typed extension points only and are skipped explicitly unless a feature supplies approved facts. | yes |
