...
| `UF-BL-004` | Parent forms own the field-tile shell, field label, helper copy, validation copy, and page/section framing. | Keeps `UploadFile` consistent with other form child controls and prevents page-layout drift. | approved |
