...
- Notes:
  ...
  - Remaining hardening work includes abuse-case controls and broader
    auth-specific security test coverage.
...
- Notes:
  ...
  - Remaining hardening work includes login abuse controls such as throttling
    or rate limiting.
...
- Notes:
  ...
  - Monitoring, alerting, and incident-response detail should be expanded
