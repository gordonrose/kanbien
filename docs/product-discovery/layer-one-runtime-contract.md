...
- Bucket:
  `discovery-harness`
- Behavior note:
  Layer 1 runtime behavior rules that must guide assistant execution are also
  promoted into
  `.codex/skills/20-planning-artifacts/product-discovery-maintainer/SKILL.md`.
  This document remains the durable request/response/state contract reference.
