...
> cleanup. The prevention lesson is now promoted into shared
> `canonicalOwnerReserve` behavior, canonical overlay containment checks,
> current verification checklists, and visual/integration coverage.
