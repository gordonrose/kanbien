...
The context-nav magnification and attachment lesson is now represented by
current context-nav reference packs, verification checklists, and visual
coverage. Treat this record as historical escaped defect evidence, not current
operating authority.
