...
after the root-admin page-host posture lesson was found in active tests and
governed adoption guidance. Current authority includes
`tests/visual/app/rootAdminShell/rootAdminShellSubNav.spec.ts`,
`tests/visual/app/rootAdminShell/rootAdminShellParity.spec.ts`, and the active
page-shell design-system artifact chain.
