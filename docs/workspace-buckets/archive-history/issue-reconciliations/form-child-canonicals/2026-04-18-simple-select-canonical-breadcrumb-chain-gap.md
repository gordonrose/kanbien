...
The child canonical breadcrumb-chain lesson is now represented by current
canonical launcher, shell registration, and simple-select verification
artifacts. Treat this record as historical escaped defect evidence, not
