...
The human-visible regression lesson is now represented by
`tests/visual/designSystem/support/helpers/humanReviewGuards.ts` and current
frontend reconciliation skill guidance. Treat this record as historical
