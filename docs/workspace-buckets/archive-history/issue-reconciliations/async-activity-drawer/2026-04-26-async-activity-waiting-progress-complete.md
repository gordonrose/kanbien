...
`docs/workspace-buckets/archive-history/issue-reconciliations/async-activity-drawer/`
after the waiting-progress lesson was found in active async-activity drawer
reference-pack, verification, component, and visual-test authority.
