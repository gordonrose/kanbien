...
> cleanup. The prevention lesson is now promoted into the list-page template
> and list-detail split layout behavior locks, reference packs, verification
> checklists, visual tests, and component inventory. Keep future authority in
> those active design-system artifacts.
