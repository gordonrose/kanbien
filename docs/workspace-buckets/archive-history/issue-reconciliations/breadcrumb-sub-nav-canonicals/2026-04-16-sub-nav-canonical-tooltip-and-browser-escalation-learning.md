...
Archived on 2026-05-27 after the canonical tooltip and browser-escalation
lessons were promoted into active design-system loop guidance, the
frontend-design-system-loop skill, breadcrumb/sub-nav/search-shell reference
artifacts, and browser-backed canonical coverage.

Use the active skill guidance, design-system loop guide, reference packs,
verification artifacts, and tests as current authority. Keep this record as
provenance for the escaped drift cluster.
