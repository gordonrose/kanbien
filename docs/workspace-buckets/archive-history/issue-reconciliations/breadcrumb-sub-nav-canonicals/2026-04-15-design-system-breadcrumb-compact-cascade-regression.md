...
Archived on 2026-05-27 after the compact breadcrumb cascade lesson was
promoted into the active breadcrumb behavior lock, sub-nav canonical reference
states, verification artifacts, and design-system breadcrumb/sub-nav tests.

Use the active breadcrumb and sub-nav design-system artifacts as current
authority. Keep this record as provenance for the escaped CSS cascade drift.
