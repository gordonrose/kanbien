...
Archived on 2026-05-27 after the first-open sub-nav canonical rendering lesson
was promoted into active sub-nav behavior locks, reference packs, verification
artifacts, `tests/audit/designSystem/subNavCanonicalCoverage.test.ts`, and
browser-backed visual canonical coverage.

Use the active sub-nav design-system artifacts and tests as current authority.
Keep this record as provenance for the escaped drift.
