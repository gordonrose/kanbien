# Index Nav Panel Header Control Default Proof

The `default` design system renders `index-nav-panel-header-control` at:

`/design-system/default/primitives/index-nav-panel-header-control`
