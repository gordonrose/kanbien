...
| --- | --- | --- | --- | --- | --- | --- |
| `record-list-component` | `review-ready` | `record-list` review-ready for `default` | `src/frontend/designSystem/layers/05-component-seam/record-list/index.mjs#recordListComponent`; `#renderRecordListComponent`; `#attachRecordListComponentController` | `docs/design-system/05-component-seam/shared/record-list/RecordListComponent-Contract.md` | `docs/design-system/05-component-seam/shared/record-list/RecordListComponent-RootAdminUsers-ReceptorMapping.md` records root-users as a non-reorder pressure test using `allowReorder: false`. | `docs/design-system/05-component-seam/render-proofs/record-list-component/RecordListComponent-RenderProof.md`; `/design-system/default/components/record-list-component`; `tests/visual/designSystem/components/recordListComponentRenderRoute.spec.ts`; `tests/unit/designSystem/recordListComponent.test.ts`; upstream `docs/design-system/04-pattern-contract/pattern-readiness-index.md`; upstream `tests/unit/designSystem/recordListPattern.test.ts` |
